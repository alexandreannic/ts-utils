...
describe('prefixLogger', function () {
  ...
  it('should prefixLogger correctly', function () {
    ...
    expect(prefixedWinstonMock.debug('Hello world', 1)).to.be.equal('PREFIX Hello world 1')

    expect(prefixedWinstonMock.info('Hello world', [2, 3])).to.be.equal('PREFIX Hello world 2,3')
  })
  ...
  it('should work when nested and do a FIFO prefixing', function () {
    ...
    expect(ftpWinstonLog.debug('Hello world', 1)).to.be.equal('[FST] [FTP] Hello world 1')
  })
  ...
  it('should not mutate the original logger', function () {
    ...
    expect(winstonMock.debug('Hello world', 1)).to.be.equal('Hello world 1')
  })
})
